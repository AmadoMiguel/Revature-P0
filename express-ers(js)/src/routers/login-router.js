...
// within all scopes.
loginRouter.post('', function (request, response) { return __awaiter(_this, void 0, void 0, function () {
    var cred, usr, pass, loginResult, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                usr = cred["username"];
                pass = cred["password"];
                return [4 /*yield*/, loginService.userLogin(usr, pass)];
            case 1:
                loginResult = _a.sent();
